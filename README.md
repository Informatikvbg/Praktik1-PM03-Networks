...
Титульный лист создать с учетом наименования курса и указания о выполнении работы в GitHub Classroom на основе шаблона из Методических указаний об оформлении Практических работ.
